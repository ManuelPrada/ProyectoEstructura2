 ...
 */
public class VentanaArco extends javax.swing.JFrame {
    ...
    public VentanaArco(Vertice arbole, Pintar pinta, int I, Frame frame) {
        this.pintar = pinta;
        this.arboles = arbole;
        this.i = I;
        frame1 = frame;
    ...
    private void initComponents() {
        ...
        panel.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Nuevo Arco", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(255, 255, 255))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VentanaArco.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                // new VentanaArco().setVisible(true);
            }
        });
    }
    private int i = 0;
