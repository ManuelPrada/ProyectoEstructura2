 ...
 */
public class EliminarArcos extends javax.swing.JFrame {
    ...
    public void R_repaint() {
        ...
        for (int j = 0; j < i; j++) {
            Pintar.pintarCirculo(VentanaPrincipal.jPanel1.getGraphics(), arboles.getCordeX(j), arboles.getCordeY(j), String.valueOf(arboles.getNombre(j)) + ";" + arboles.getNombreCiudad(j));
    ...
    public EliminarArcos(Pintar pinta, Vertice arbole, int ii, Frame fram) {
        initComponents();
        i = ii;
        this.pintar = pinta;
        this.arboles = arbole;
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Eliminar Arco", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 0, 11), new java.awt.Color(255, 255, 255))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (n1.getText().length() < 1 || n2.getText().length() < 1) {
            ...
            if (x == y) {
                JOptionPane.showMessageDialog(null, "Error.. Debe digitar un vertice diferente a : " + y);
            } else if (x < 0 || x >= i || y < 0 || y >= i) {
                JOptionPane.showMessageDialog(null, "Error.. vertices No validos ");
            } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EliminarArcos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
